...
export default function ShortcutGuide({
  ...
  const exampleUrl = `${baseUrl}/api/wallpaper?width=${width}&height=${height}&timezone=${encodeURIComponent(
    timezone
  )}&mode=${mode}`;
      ...
      <div className="space-y-6">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-800 dark:text-gray-200">
            ...
            <li>
              ...
              <div className="ml-6 mt-2 p-2 bg-white dark:bg-gray-700 rounded border dark:border-gray-600">
                <p className="text-xs font-semibold mb-1 dark:text-gray-200">
                  URL to use:
                </p>
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          ...
          <ul className="space-y-2 text-sm dark:text-gray-300">
            <li>
              <code className="bg-gray-200 dark:bg-gray-600 dark:text-gray-200 px-2 py-1 rounded">
                width
              </code>{" "}
